...
import { useProfile, updateProfile, updateSkillProfiles } from '@/lib/hooks/useProfile';
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="mt-4 text-sm text-gray-500">
            Note: These buttons demonstrate SWR optimistic updates with Hono RPC. Data updates
            immediately in the UI, then syncs with the backend.
          </p>
        </div>
