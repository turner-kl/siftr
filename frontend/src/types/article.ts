...
export function isValidCategory(value: unknown): value is Category {
  return (
    typeof value === "string" && ["tech", "hr", "business"].includes(value)
  );
}
...
export function isValidPriority(value: unknown): value is Priority {
  return (
    typeof value === "string" &&
    ["must-read", "recommended", "reference", "skip"].includes(value)
  );
}
...
export type ArticlePreview = Pick<
  Article,
  "id" | "title" | "summary" | "category" | "priority"
>;
